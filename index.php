...
############################################################################################
$sys["page_title"] 	= "Qualifikationen";
############################################################################################
...
if ( isset ( $res_id ) AND !empty ( $res_data["res_id"] ) AND $access )
{
	...
	?>
		...
		{
		?>
			<a href="../bew/hinventar/edit/?res_id=<?PHP echo ( $res_data["><img src="<?PHP echo ( $sys["icon_path"] ); ?>global_edit.gif" alt="Qualifikation bearbeiten" border="0" /> Qualifikation bearbeiten</a><br />
			<a href="../bew/hinventar/del/?res_id=<?PHP echo ( $res_data["><img src="<?PHP echo ( $sys["icon_path"] ); ?>global_del.gif" alt="Qualifikation l�schen" border="0" /> Qualifikation l�schen</a><br />
		<?PHP
		}
		?>
		</p>
...
else
{
	if ( isset ( $_GET["alert"] ) )
	{
		...
		{
			echo ( "<p class=\"notification\"><b>Qualifikation erfolgreich gespeichert.</b></p>\n" );
		}
	...
	{
		// Nur Administratoren d�rfen Qualifikationen erstellen
		if ( $sys["user"]["role_id"] == 5 )
		{
			echo ( " . $sys["icon_path"] . "global_add.gif\" alt=\"Qualifikation erstellen\" border=\"0\" /> Qualifikation erstellen</a></p>\n" );
		}
